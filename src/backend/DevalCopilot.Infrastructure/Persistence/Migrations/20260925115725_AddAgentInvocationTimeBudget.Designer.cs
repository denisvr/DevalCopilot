...
namespace DevalCopilot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925115725_AddAgentInvocationTimeBudget")]
    partial class AddAgentInvocationTimeBudget
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevalCopilot.Domain.Features.Runs.Attempt", b =>
                {
                    ...
                    b.Property<int?>("AgentBudgetSlot")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RunId", "AgentBudgetSlot")
                        .IsUnique()
            ...
            modelBuilder.Entity("DevalCopilot.Domain.Features.Runs.Run", b =>
                {
                    ...
                    b.Property<int>("MaximumAgentAttempts")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(16);

                    b.Property<long?>("MaximumAgentInvocationTime")
                        .HasColumnType("INTEGER");
