...
/// <summary>
/// The outcome of one Codex implementation-review invocation attempt. Never carries raw
...
/// </summary>
public sealed record ImplementationReviewInvocationResult(
    ImplementationReviewInvocationOutcome Outcome,
