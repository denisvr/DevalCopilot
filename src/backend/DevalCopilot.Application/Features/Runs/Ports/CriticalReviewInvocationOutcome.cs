...
/// response is a valid Acceptance or Challenge set. That is a separate, later validation step
/// over the sealed artifact this invocation produces.
/// </summary>
public enum CriticalReviewInvocationOutcome
{
    /// <summary>The process ran to completion and exited zero. Says nothing about whether its
    /// final-response file contains a valid Acceptance or Challenge set.</summary>
    Exited,
