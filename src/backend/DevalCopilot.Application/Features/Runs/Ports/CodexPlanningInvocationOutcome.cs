...
/// response is a valid Proposal. That is a separate, later validation step over the sealed
/// artifact this invocation produces.
/// </summary>
public enum CodexPlanningInvocationOutcome
{
    /// <summary>The process ran to completion and exited zero. Says nothing about whether its
    /// final-response file contains a valid Proposal.</summary>
    Exited,
